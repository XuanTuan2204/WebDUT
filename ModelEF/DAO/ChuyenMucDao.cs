...
namespace ModelEF.DAO
{
    public class ChuyenMucDao
    {
        ...
        public List<ChuyenMuc> ListAll()
        {
            return db.ChuyenMucs.Where(x => x.Trangthai == true && x.MaLoaiChuyenMuc=="L01").OrderBy(y => y.MaChuyenMuc).ToList();
        }
        public List<ChuyenMuc> ListAll1()
        {
            return db.ChuyenMucs.Where(x => x.Trangthai == true && x.MaLoaiChuyenMuc == "L03").OrderBy(y => y.MaChuyenMuc).ToList();
        }
        public List<ChuyenMuc> ListTTTS()
        {
            return db.ChuyenMucs.Where(x => x.Trangthai == true && x.MaLoaiChuyenMuc == "L02").OrderBy(y => y.MaChuyenMuc).ToList();
        }
    }
}
